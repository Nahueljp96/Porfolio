                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            <li class="nav-item">
                                <a class="nav-link py-1 px-3 px-sm-4 <?php echo $pg== "index"? "active":""?>" href="index.php">Inicio</a><!-- La linea de codigo PHP funciona con la variable PG puesta en las distintas páginas, pregunta si esta en "index" y si lo esta "active" asi se pone el recuadro, SINO devuelve un valor vacio"-->
                            </li>
                            <li class="nav-item">
